...
namespace DataManager.Library.DataAccess
{
    public class GeneralType_Data : IGeneralType_Data
    {
        ...
        {
            _sql.SaveData("dbo.spSaveGenType", new { typeName = genType.TypeName }, _config.GetSection("Data")[DB_Key.SO_DB_Key()]);
        }

        public List<GeneralTypeModel> GetAll()
        {
            var typeList = _sql.LoadData<GeneralTypeModel, dynamic>("dbo.spGetAllGenType", new { }, _config.GetSection("Data")[DB_Key.SO_DB_Key()]);
            return typeList;
        }

        public void Edit(GeneralTypeModel generalTypeDataModel)
        {
            _sql.SaveData("dbo.spEditGentype", generalTypeDataModel, _config.GetSection("Data")[DB_Key.SO_DB_Key()]);
        }

        public void Delete(int id)
        {
            _sql.SaveData("dbo.spDeleteGenType", new { id = id }, _config.GetSection("Data")[DB_Key.SO_DB_Key()]);
        }
